const CACHE="fudan-study-v1";
const APP=["./","./index.html","./styles.css","./app.js","./culture-data.js","./manifest.webmanifest","./icon.svg","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./背诵系统使用说明.md","./文化要略_30个背诵单元.md","./苹果手机安装说明.md"];
